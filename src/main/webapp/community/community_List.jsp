...
<%@ taglib prefix="c" uri = "http://java.sun.com/jsp/jstl/core" %>
        ...
        <div style = "display: flex; justify-content: space-between; padding-top:30px;">
        	<div></div>
        	<h2> 동아리 커뮤니티 페이지</h2>
        	<button class="btn btn-dark" onclick ="location.href ='commu?cmd=write'"> 글 등록 </button>
        </div>
			...
			<!--  main 부분 개별 블럭  -->
				<div class="col mb-5">
					<div class="card h-100" style = " width:300px; height: 300px; margin: 5px 50px;">
						<!-- House image-->
						<img class="card-img-top" src="/together/community/img/${dto.ofile}" alt="diaryImg" 
						...
						<div class="text-center"><a class="btn btn-outline-dark mt-auto" href="<%= request.getContextPath()%>/commu?cmd=view&num=${dto.num}">상세 보기</a></div>
						</div>
					</div>
				</div>
			</c:forEach>
