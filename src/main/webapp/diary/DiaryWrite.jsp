...
%>
	...
	<div>
		<form method = "post" action ="/together/diary?cmd=write_process" enctype = "multipart/form-data">
		...
		<form method="post" action ="diary?cmd=list&page=0">
			<button type = "submit"> 취소 </button>
		</form>
	</div>
	
	<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=31a816204cc19a3cc02d0848b0a2115b"></script>
	<script>
	//이미지 미리보기
